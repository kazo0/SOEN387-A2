...
public class JdbcUtilViaSSH {
	...
	public static SSHjdbcSession getConnection() {
		...
		String databaseName = "soen387e";
		String username = "soen387e";
		String password = "g43j87";
	...
	private static SSHjdbcSession doSshTunnel() {
		String strSshUser = "s_biloga"; // SSH loging username
		String strSshPassword = "Grav!s09"; // SSH login password
