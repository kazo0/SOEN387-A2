...
public class JdbcUtilViaSSH {
	...
	public static SSHjdbcSession getConnection() {
		...
		String databaseName = "yuhong";
		String username = "yuhong";
		String password = "SOEN387f";
	...
	private static SSHjdbcSession doSshTunnel() {
		String strSshUser = "YOUR ENCS ACCOUNT"; // SSH loging username
